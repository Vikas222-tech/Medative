        ...
        <View style={styles.outerview}>
            <Pressable
                ...
                <View style={styles.round}>
                    <Image source={require('../assets/images/outbutton.png')} style={styles.imground} />
                </View>
            </Pressable>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.miv}>
                    <TouchableOpacity onPressOut={() => onClicks('block1', 'signin')}>
                        <View style={setStyle2 == 'block1' ? styles.border : { padding: 10
                            ,height:39,borderColor:'rgba(170, 170, 170, 1)', backgroundColor: '#F5F5F5', borderRadius: 19.5, flexDirection: 'row', justifyContent: 'space-evenly', width: '100%', }}>
                            <View style={{ width: '10%',position :'relative',alignSelf:'center' }}>
                                ...
                                {setStyle2 == "block1" ?
                                    ...
                                    <Image source={require('../assets/images/mesg.png')} resizeMode='center' style={styles.imageb} />
                                }
                            </View>
                    ...
                    <TouchableOpacity onPressOut={() => onClicks('block2')} style={{ marginTop: '5%' }}>
                        <View style={setStyle2 == 'block2' ? styles.border : { padding: 10
                            ,height:39,borderColor:'rgba(170, 170, 170, 1)', backgroundColor: '#F5F5F5', borderRadius: 19.5, flexDirection: 'row', justifyContent: 'space-evenly', width: '100%' }}>
                            <View style={{ width: '10%',position :'relative',alignSelf:'center' }}>
                    ...
                    <TouchableOpacity onPressOut={() => onClicks('block3')} style={{ marginTop: '5%' }}>
                        <View style={setStyle2 == 'block3' ? styles.border : { padding: 10, backgroundColor: '#F5F5F5'
                        ,height:39,borderColor:'rgba(170, 170, 170, 1)', borderRadius: 19.5, flexDirection: 'row', justifyContent: 'space-evenly', width: '100%' }}>
                            <View style={{ width: '10%',position :'relative',alignSelf:'center' }}>
                    ...
                    <TouchableOpacity onPressOut={() => onClicks('block4')} style={{ marginTop: '5%' }}>
                        <View style={setStyle2 == 'block4' ? styles.border : { padding: 10, backgroundColor: '#F5F5F5', borderRadius: 19.5
                        ,height:39,borderColor:'rgba(170, 170, 170, 1)', flexDirection: 'row', justifyContent: 'space-evenly', width: '100%' }}>
                            <View style={{ width: '10%',position :'relative',alignSelf:'center' }}>
